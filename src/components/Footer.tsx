...
Жизнь — искусство, одежда — его проявление. Создавай каждый день как шедевр, носи каждый момент как произведение.              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              © {currentYear} Harakez вск права защищены. Все права на контент принадлежат их владельцам. Использование материалов сайта возможно только с разрешения правообладателей.
            </p>
          </div>
        </div>
      </div>
